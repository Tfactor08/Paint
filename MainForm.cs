...
namespace PaintApplicationAssignment
{
    public partial class MainForm : Form
    {
        ...
        {
            string message = "Хотите сохранить рисунок";
            string title = "";
        ...
        {
            DialogResult result;
            result = MessageBox.Show("Вы уверены, что хотите выйти?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (result == DialogResult.Yes)
            {
                Application.Exit();
            }
        ...
        {
            MessageBox.Show("Работу выполнил студент группы 2231117 Гарипов Булат");
        }
